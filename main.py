...
from board import Apppage
from login_page import Login_Page
from about import About
from wtd import Wtd
from adddata_page import AddData_Page
from delete_page import DeleteData_Page
from satuan_page import Satuan_Page
...
class Window(tk.Tk):
	...
	def create_add_satuan_page(self):
		self.pages['Satuan_Page']  = Satuan_Page()
	...
	def create_menus(self):
		...
		self.FileMenu.add_command(label='Add Satuan',command = self.create_add_satuan_page)
